...
% state. The fidelity is returned, along with its gradient with respect to 
% amplitudes of all control operators at every time step of the shaped pulse.
% This function is for the Hilbert space version of GRAPE.
% Syntax:
%
%	[traj_data,fidelity,grad]=grape_hilb(spin_system,drifts,controls,waveform,init,targ,fidelity_type) 
%
% Parameters:
%
...
function [traj_data,fidelity,grad]=grape_hilb(spin_system,drifts,controls,waveform,init,targ,fidelity_type) %#ok<*PFBNS>
